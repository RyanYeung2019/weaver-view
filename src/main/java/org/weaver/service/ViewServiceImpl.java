...
import org.weaver.query.entity.FieldInfo;
...
public class ViewServiceImpl implements ViewService {
	...
	public <T> void updateViewInfo(ViewEn viewEn, ViewData<T> data, RequestConfig viewReqConfig) {
		...
		for (ViewField viewField : viewFields) {
			...
			fieldInfo.setRemark(viewField.getRemark());
		...
		data.setRemark(viewEn.getRemark());
	...
	public ViewEn getViewInfo(String dataSource, String sql,String tableId,Map<String, Object> critParams) {
		...
		if(tableId!=null) {
			...
			for(FieldEn fieldEn:tableEn.getFieldEns()) {
				...
				viewField.setSqlType(fieldEn.getSqlType());
				viewField.setType(fieldEn.getType());
				viewField.setTypeDb(fieldEn.getTypeDb());
				viewField.setTypeJava(fieldEn.getTypeJava());
				viewField.setPreci(fieldEn.getPreci());
				viewField.setScale(fieldEn.getScale());
